        ...
        <table class="table-auto w-full">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border-2 text-left px-4 py-2 cursor-pointer text-gray-500" wire:click="sortBy('name')">
                        <div class="flex items-center">
                            <button class="font-bold underline">Name</button>
                            <x-sort-icon sortField="name" :sort-by="$sortBy" :sort-asc="$sortAsc" />
                        </div>
                    </th>
                    <th class="border-2 text-left px-4 py-2 cursor-pointer text-gray-500" wire:click="sortBy('email')">
                        <div class="flex items-center">
                            <button class="font-bold underline">Email</button>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border py-2 px-4">{{ $item->name }}</span></td>
                    ...
                    <td class="border py-2 text-center">
                      ...
                      @else
                      <span class="px-2 py-1 text-xs font-bold text-green-600 border border-green-500 rounded-md cursor-not-allowed">
                        Active
                      </span>
                      @endif
                    </td>
            ...
            <div class="w-full h-full text-center">
                <div class="flex h-full flex-col justify-between">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-xs py-2 px-6">
                        Are you sure you want to delete this author and all related posts ?
                    </p>
